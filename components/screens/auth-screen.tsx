        ...
        <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
          ...
          <div className="space-y-2">
            <button
              ...
              className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-white py-2.5 text-sm font-semibold text-foreground shadow-sm transition-colors hover:bg-accent disabled:opacity-60"
            >
              {oauthLoading === 'google' ? <Loader2 className="h-4.5 w-4.5 animate-spin" /> : <GoogleIcon className="h-4.5 w-4.5" />}
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-white py-2.5 text-sm font-semibold text-foreground shadow-sm transition-colors hover:bg-accent disabled:opacity-60"
            >
              {oauthLoading === 'microsoft' ? <Loader2 className="h-4.5 w-4.5 animate-spin" /> : <MicrosoftIcon className="h-4.5 w-4.5" />}
