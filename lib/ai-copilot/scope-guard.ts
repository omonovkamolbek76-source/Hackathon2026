...
const BUSINESS_LEXICON =
  /biznes|tadbirkor|savdo|sotuv|kredit|soliq|moliya|moliyalashtirish|xarajat|daromad|foyda|reja|supplier|yetkazib|marketing|mijoz|narx|mahsulot|xizmat|bank|obuna|vazifa|kirim|chiqim|breakeven|startap|g['\u2018\u2019]oya|sarmoya|investor|ariza|hisobot|buxgalter|to['\u2018\u2019]lov|budjet|bozor|tahlil|analytics|platforma|tadbirkorai|uskuna|tovar|oylik|so['\u2018\u2019]m|million/i;
